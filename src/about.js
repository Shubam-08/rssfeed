  ...
  return (
    ...
    <h1>{data.data.name}</h1>
      <body class="bg-gray-200 font-sans flex flex-col items-center">
        <header
          id="header"
          class="bg-indigo-700 py-3 px-4 border-b-4 border-pink-500 border-solid w-full flex justify-center"
        >
          <div class="max-w-4xl w-full">
            <div class="text-pink-400 flex justify-between">
              <svg
                class="h-8 fill-current text-pink-400"
              ...
              <nav id="nav-bar">
                <button
                  class="sm:hidden text-gray-500 block hover:text-gray-300 duration-500 transition"
                  type="button"
                >
                ...
                <div class="hidden sm:flex sm:justify-around sm:w-96 border border-red-500 ">
                  <a class="hidden sm:inline nav-link" href="#how-it-works">
                    How it works
                  </a>
                  <a class="hidden sm:inline nav-link" href="#advantages">
                    Advantages
                  </a>
                  <a class="hidden sm:inline nav-link" href="#form">
                    Get PDF
                  </a>
                </div>
              </nav>
            ...
            <div class="my-4">
              ...
              <div class="my-4 relative flex justify-between">
                <div class="">
                  <button type="button">
                    <a
                      class="tracking-wide bg-pink-500 text-indigo-100 py-2 px-4 font-bold rounded-full text-base hover:bg-pink-600 transition duration-500"
                      href="#"
                      rel="noopener"
                      target="_blank"
                    >
                ...
                <div class="border-4 rounded-full border-pink-500 bg-white p-5 absolute right-0">
                  <img class="hidden" src="#" id="header-img" alt="image" />
                  <svg
                    width="64px"
                    height="64px"
                    viewBox="0 0 256 154"
        ...
        <main class="mt-16 w-full flex flex-col items-center">
          <div class="max-w-4xl mx-4">
            <h2
              id="how-it-works"
              class="text-xl font-bold text-indigo-700 border-b border-indigo-700 pb-1"
            >
              How It Works
            </h2>
            ...
            <h2
              id="advantages"
              class="mt-8 text-xl font-bold text-indigo-700 border-b border-indigo-700 pb-1"
            >
              Advantages
            </h2>
            <div class="flex flex-col sm:flex-row sm:-m-4">
              <div class="sm:w-1/3 mt-4">
                <div class="h-full border-b-4 border-pink-500 bg-white flex flex-col items-center p-8 rounded-lg text-center sm:m-4 sm:p-3">
                  <div class="bg-gray-200 rounded-full text-indigo-700 w-16 h-16 p-2">
                    <svg
                  ...
                  <div class="font-bold mt-4">No Custom CSS</div>
                  <div class="mt-4 text-gray-600 text-sm tracking-wide">
              ...
              <div class="sm:w-1/3 mt-4">
                <div class="h-full border-b-4 border-pink-500 bg-white flex flex-col items-center p-8 rounded-lg text-center sm:m-4 sm:p-3">
                  ...
                  <div class="font-bold mt-4">Developer Experience</div>
                  <div class="mt-4 text-gray-600 text-sm tracking-wide">
              ...
              <div class="sm:w-1/3 mt-4">
                <div class="h-full border-b-4 border-pink-500 bg-white flex flex-col items-center p-8 rounded-lg text-center sm:m-4 sm:p-3">
                  ...
                  <div class="font-bold mt-4">Mobile Friendly</div>
                  <div class="mt-4 text-gray-600 text-sm tracking-wide">
          ...
          <div class="bg-gray-800 py-12 mt-12 w-full flex flex-col items-center border-t-2 norder-black">
            ...
            <form
              id="form"
              class="max-w-xl w-full text-gray-200 mt-4 px-8 md:px-0"
              action="#"
              method="post"
            >
              <div class="flex flex-col md:flex-row md:-mx-2">
                ...
                <input
                  class="bg-blue-900 mt-4 border border-gray-600 rounded-lg py-2 px-4 w-full md:mx-2"
                  type="text"
              ...
              <div class="flex flex-col md:flex-row md:-mx-2">
                <button class="bg-blue-600 hover:bg-blue-500 text-sm mt-4 rounded-lg py-2 px-4 w-full md:mx-2">
                  Create account
                </button>
              </div>
            </form>
